    ...
    <section class="px-4 py-6">
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-2xl flex flex-col justify-center items-center relative shadow-2xl shadow-black hover:scale-105 hover:shadow-lg transition-all ease-in-out duration-700">
                ...
                <div v-show="popupVisible" class="absolute inset-0 bg-panel flex items-center justify-center gap-4 rounded-2xl p-4">
            ...
            <div class="rounded-2xl flex justify-center items-center shadow-2xl shadow-black hover:scale-105 hover:shadow-lg transition-all ease-in-out duration-700 p-6">
