...
<template>
       <div class=" h-180 w-80 rounded-2xl flex flex-col gap-5 items-center justify-center m-8 wood-texture overflow-y-hidden">
            ...
            <div v-show="popupVisible"  class="h-180 w-300 absolute z-50 top-1/8 left-1/2 transform -translate-x-1/2 wood-texture rounded-2xl flex items-center justify-center"> 
                <metas class="h-full w-full"/> 
                <div class="flex flex-col items-center justify-start h-full w-full p-5">
                ...
                <div v-else class="h-full w-full flex flex-col items-center justify-start overflow-y-auto">
                    <div v-for="m in metaCompletada" :key="m.id" class="flex items-center justify-start gap-5 -20 w-full p-1">
